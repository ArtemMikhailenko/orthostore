          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="flex items-center gap-1.5">
              <a href="https://t.me/orthostore" target="_blank" rel="noopener noreferrer"
                className="w-6 h-6 bg-stone-800 rounded-full flex items-center justify-center hover:bg-sky-500 transition-all duration-300"
                title="Telegram">
                <FaTelegramPlane className="w-3 h-3 text-white" />
              </a>
              <a href="viber://chat?number=%2B380503039494" target="_blank" rel="noopener noreferrer"
                className="w-6 h-6 bg-stone-800 rounded-full flex items-center justify-center hover:bg-purple-600 transition-all duration-300"
                title="Viber">
                <FaViber className="w-3 h-3 text-white" />
              </a>
              <a href="https://instagram.com/orthostore.ua" target="_blank" rel="noopener noreferrer"
                className="w-6 h-6 bg-stone-800 rounded-full flex items-center justify-center hover:bg-pink-600 transition-all duration-300"
                title="Instagram">
                <FaInstagram className="w-3 h-3 text-white" />
              </a>
              <a href="https://facebook.com/orthostore.ua" target="_blank" rel="noopener noreferrer"
                className="w-6 h-6 bg-stone-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all duration-300"
                title="Facebook">
                <FaFacebookF className="w-3 h-3 text-white" />
              </a>
              <a href="https://tiktok.com/@orthostore.ua" target="_blank" rel="noopener noreferrer"
                className="w-6 h-6 bg-stone-800 rounded-full flex items-center justify-center hover:bg-stone-600 transition-all duration-300"
                title="TikTok">
      ...
      <div className="border-t border-stone-200 p-4">
        <div className="space-y-3">
          ...
          <div className="text-xs text-stone-500 px-4">
            ...
            <div>orthostore.com.ua@gmail.com</div>
          </div>
        </div>
      </div>
    </div>
