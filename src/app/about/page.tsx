      ...
      <section className="max-w-5xl mx-auto px-6 py-16 lg:py-20">
        <div className="space-y-12">
          <div className="space-y-6 text-base lg:text-lg text-stone-700 leading-relaxed">
            ...
            <p>
              Ми з повагою ставимося як до великих компаній, цінуємо їхній досвід і готові поставити будь-яку кількість ортодонтической продукції, так і до кожному бажаючому працювати з нами доктору. Інтернет-магазин ортодонтической продукції Orthostore слідуючи інновацій в своїй сфері діяльності і пропонує продукцію високої якості від провідних світових брендів.
            </p>
          </div>
        </div>
      </section>
