...
export default function CheckoutPage() {
  ...
  const discount = MOCK_CART_ITEMS.reduce((sum, item) => {
      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            {[
              ...
              return (
                <React.Fragment key={s.id}>
                  ...
                  {index < 3 && (
                    <div className={cn(
                      'h-1 flex-1 rounded-full transition-all duration-300 mt-6',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Step 1: Contact Info */}
            <div className={cn(
              'bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden transition-all duration-300',
              ...
              {step === 'info' && (
                <div className="p-6 space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Іван"
                        className="w-full px-4 py-3 border border-stone-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-stone-900 focus:border-transparent"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-stone-700 mb-2">
                  ...
                  <button
                    ...
                    className="w-full bg-stone-900 text-white py-3 rounded-xl hover:bg-stone-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                  >
                    Продовжити
                  </button>
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 border border-stone-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-stone-900 focus:border-transparent resize-none"
                    />
                  </div>

                  <button
                    onClick={() => setStep('confirm')}
                    className="w-full bg-stone-900 text-white py-3 rounded-xl hover:bg-stone-800 transition-colors font-medium"
                  >
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-emerald-500 text-white py-4 rounded-xl hover:bg-emerald-600 transition-colors font-semibold text-lg shadow-lg shadow-emerald-500/20"
                  >
                    Перейти до оплати
                  </button>
